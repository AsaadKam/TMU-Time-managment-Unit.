...
#define SET_BIT(REG,sgu16_TMU_index) (REG|=(1<<sgu16_TMU_index))
#define CLR_BIT(REG,sgu16_TMU_index) (REG&=(~(1<<sgu16_TMU_index)))
#define GET_BIT(REG,sgu16_TMU_index) ((REG>>sgu16_TMU_index)&0x01)
#define TOGGLE_BIT(REG,sgu16_TMU_index) (REG^=(1<<sgu16_TMU_index))
#define TOGGLE_PORT(REG) (REG^=0xff)
#define BIT_IS_SET(REG,sgu16_TMU_index) (REG&(1<<sgu16_TMU_index))
#define BIT_IS_CLR(REG,sgu16_TMU_index) (!(REG&(1<<sgu16_TMU_index)))
